...
public class DamagePopUp : MonoBehaviour
{
    ...
    private float _moveSpeedY = 0.2f;
    private Color _color;
    
    public static DamagePopUp Create(Vector2 position, int damage, int layer)
    {
        DamagePopUp popUp = Instantiate(DamagePopUpRepository.instance.GetDamagePopUp(layer), position,
            Quaternion.identity);
